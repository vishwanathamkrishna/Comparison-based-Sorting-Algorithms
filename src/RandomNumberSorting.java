...
public class RandomNumberSorting {
	...
	private static final int RANGE_FOR_RANDOM_NUMBERS = 5000;
	...
	public static void main(String[] args) {
			...
			int arrayToSort[] = getRandomNumberArray(n);
			...
			int arrayToSort4[] = Arrays.copyOf(arrayToSort, arrayToSort.length);
			
			
	        //INSERTION SORT
	        System.out.println("<<<Unsorted array elements>>>: "+Arrays.toString(arrayToSort));
	        ...
	        //MODIFIED QUICK SORT
	        System.out.println("<<<Unsorted array elements>>>: "+Arrays.toString(arrayToSort1));
	        long mquickstarttime = System.nanoTime();
	        medianQuickSort(arrayToSort1, 0, arrayToSort1.length-1);
	        ...
	        System.out.println("<<<Sorted Array>>>: "+Arrays.toString(arrayToSort1));
	        
	        System.out.println("\n");
	        
	        //INPLACE QUICK SORT
	        System.out.println("<<<Unsorted array elements>>>: "+Arrays.toString(arrayToSort2));
	        long iquickstarttime = System.nanoTime();
	        inPlaceQuickSort(arrayToSort2, 0, arrayToSort2.length-1);
	        ...
	        System.out.println("<<<Sorted Array>>>: "+Arrays.toString(arrayToSort2));
	        
	        System.out.println("\n");
	        
	        //MERGE SORT
	        System.out.println("<<<Unsorted array elements>>>: "+Arrays.toString(arrayToSort3));
	        long  mergestarttime = System.nanoTime();     
	        mergesort(arrayToSort3, 0, arrayToSort3.length-1); 
	        long mergeendtime = System.nanoTime();
	        System.out.println("Merge Sort Execution time in nanoseconds:"+(mergeendtime-mergestarttime));
	        System.out.println("<<<Sorted Array>>>: "+Arrays.toString(arrayToSort3));
	        
	        System.out.println("\n");
	        
	        //HEAP SORT
	        System.out.println("<<<Unsorted array elements>>>: "+Arrays.toString(arrayToSort4));
	        long heapstarttime = System.nanoTime();     
	        heapsort(arrayToSort4);
	        long heapendtime = System.nanoTime();
	        System.out.println("Heap Sort Execution time in nanoseconds:"+(heapendtime-heapstarttime));        
	        System.out.println("<<<Sorted Array>>>: "+Arrays.toString(arrayToSort4));
	...
	private static void inPlaceQuickSort(int[] arrayToSort2, int left, int right) {
		...
		int pivot = rand.nextInt(randomInt) + left;
 ...
 // Merges two subarrays of arr[]. 
    ...
    private static int[] getRandomNumberArray(int arrSize) {
		int[] array = new int[arrSize];
		for(int i = 0; i < array.length; i++) {
			array[i] = rand.nextInt(RANGE_FOR_RANDOM_NUMBERS);
		}
		return array;
	}
}
